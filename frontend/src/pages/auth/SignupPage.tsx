          ...
          {step === 'details' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="flex flex-col gap-4">
              <div>
                ...
                {devOtpCode && (
                  <div className="mt-3 bg-emerald-50 border border-emerald-200 rounded-lg p-2.5 text-center text-xs text-emerald-800 font-medium">
                    🔑 Dev mode code: <span className="font-mono font-bold tracking-widest">{devOtpCode}</span>
                  </div>
                )}
              </div>
